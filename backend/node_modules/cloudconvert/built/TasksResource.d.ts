...
export declare type TaskOperation = TaskConvert | TaskCapture | TaskOptimize | TaskThumbnail | TaskMerge | TaskArchive | TaskCommand;
...
export default class TasksResource {
    ...
    upload(task: Task, stream: Stream): Promise<any>;
